...
if GUIinput:
    ...
    GItimeMaks = 168.0  # maksimale tid i timer efter primær indlæggelse en genindlæggelse kan registreres
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
