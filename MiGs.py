...
def linelistdic(listversion='full'):
    ...
    if listversion == 'full':
        ...
        linelist['lyl']      = ['Ly-limit$\\lambda$912'            ,  912.,              'right'      , 'byhand']
        linelist['lycont']   = ['Ly-cont$\\lambda895$'             ,  895.,              'right'      , 'byhand']
        ...
        #                         name                           wavelength[A]  horizontalalignment      lineref
        linelist['siii']     = ['SiIII$\\lambda$1261'             , 1261.000 ,         'left'       , 'A. Feltre email']
        ...
        linelist['siii']     = ['SiIII$\\lambda$1528'             , 1527.7070,         'left'       , 'A. Feltre email']
        ...
        #                         name                           wavelength[A]  horizontalalignment      lineref
        linelist['siii1']     = ['SiIII$\\lambda$1265'             , 1265     ,         'left'       , 'A. Feltre email']
        linelist['siii2']     = ['SiIII$\\lambda$1309'             , 1309.2757,         'left'       , 'A. Feltre email']
        linelist['siii3']     = ['SiIII$\\lambda$1533'             , 1533.4312,         'left'       , 'A. Feltre email']
